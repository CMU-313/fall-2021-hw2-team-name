...
class ModelCopy:
    ...
    def __init__(
        self, model, bind_link=False, excludes=None, register_permission=False,
        extra_kwargs=None
    ):
    ...
    def add_fields(
        self, field_names, field_value_gets=None,
    ...
    def copy(self, instance, values=None):
        ...
        if isinstance(self.model, mptt.models.MPTTModelBase):
            ...
            for source_node in instance.get_family():
    ...
    def _copy(self, instance, values=None, _get_or_create=False):
        ...
        for field, value in self.field_value_templates.items():
            value = value.format(**context) or None
            new_model_dictionary[field] = value
        ...
        if _get_or_create:
            ...
            new_instance = self.model._meta.default_manager.create(
                **new_model_dictionary
            )
